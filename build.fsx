...
let summary = ".NET wrapper for libwebp"
...
let gitName = "libwebp-net"

// The url for the raw files hosted
let gitRaw = environVarOrDefault "gitRaw" "https://raw.github.com/imazen"
...
Target "RunTests" (fun _ ->
    ...
    |> NUnit (fun p ->
        { p with
            ...
            NUnitXmlOutputPath = "TestResults.xml" })
)
