...
let githubLink = "http://github.com/imazen/libwebp-net"

// Specify more information about your project
let info =
  [ "project-name", "libwebp-net"
    "project-author", "Imazen"
    "project-summary", "A .NET wrapper for libwebp 0.4.1"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/Imazen.WebP" ]
